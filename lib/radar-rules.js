  ...
  'pixiv.net' : {
    ...
    www : [
      ...
      },
      {
        ...
        docs : 'https://docs.rsshub.app/social-media.html#pixiv',
        source : '/ranking.php',
        target : (params, url) => `/pixiv/ranking/${
            new URL(url).searchParams.get('mode') || 'daily'}`,
      },
      {
        title : '关键词',
        docs : 'https://docs.rsshub.app/social-media.html#pixiv',
    ...
    '.' : [
      {
        ...
        source : '/:id',
        target : (params) => {
          if (params.id !== 'home' && params.id !== 'explore' &&
              params.id !== 'notifications' && params.id !== 'messages' &&
              params.id !== 'explore' && params.id !== 'search') {
  ...
  'qdaily.com' : {
    ...
    www : [
      ...
      },
      {
        ...
        target : (params) =>
            `/qdaily/column/${params.idd.replace('.html', '')}`,
      },
      {
        title : '分类',
        docs : 'https://docs.rsshub.app/new-media.html#hao-qi-xin-ri-bao',
    ...
    chrome : [
      {
        ...
        docs :
            'https://docs.rsshub.app/program-update.html#chrome-wang-shang-ying-yong-dian',
    ...
    yjsy : [
      {
        title : '研究生院 - 通知公告',
        docs :
            'https://docs.rsshub.app/university.html#ha-er-bin-gong-cheng-da-xue',
        source : '/*',
    ...
    www : [
      {
        title : '基金要闻',
        docs :
            'https://docs.rsshub.app/other.html#guo-jia-zi-ran-ke-xue-ji-jin-wei-yuan-hui',
        source : '/*',
    ...
    'trackings.post' : [
      {
        title : '郵便・荷物の追跡',
        docs :
            'https://docs.rsshub.app/other.html#ri-ben-you-bian-you-bian-zhui-ji-サービス',
    ...
    '.' : [
      {
        title : '更新列表',
        docs :
            'https://docs.rsshub.app/multimedia.html#zhui-xin-fan-ri-ju-zhan',
        source : [ '/main.php' ],
