                ...
                item.find('.js-video')
                    ...
                    .reduce(
                        (accumulator, currentValue) =>
                            ...
                            `<video src="${
                                $(currentValue)
                                    .attr('data-videourl')}" poster="${
                                $(currentValue)
                                    .attr(
                                        'data-videoimg')}" controls="controls"></video>`,
                        '');
            ...
            const images =
                item.find('.imgc img')
                    ...
                    .reduce((accumulator, currentValue) =>
                                accumulator +
                                `<img src="${
                                    $(currentValue).attr('data-origin') ||
                                    $(currentValue).attr('src')}"/>`,
                            '');
